...
struct QuizView: View {
    ...
    let quizItems: [QuizItem] = [
            ...
            QuizItem(question: "iPhoneアプリを開発するときに使うものは？", options: ["Xcode", "Android Studio", "cloud9"], correctAnswerIndex: 0),
            //QuizItem(question: <#T##String#>, options: <#T##[String]#>, correctAnswerIndex: <#T##Int#>)
            ]
                ...
                ZStack {
                    VStack {
                        ...
                        Text(isCorrect ? "正解！" : "不正解... 正解は「\(currentQuestion.options[currentQuestion.correctAnswerIndex])」")
                            ...
                            .opacity(isShowingFeedback ? 1 : 0) //透明度の切り替えで表示してる
            ...
            func answerTapped(_ index: Int) {
                ...
                //次の問題を表示する
                DispatchQueue.main.asyncAfter(deadline: .now() + 2.0) {//２秒後に実行する関数
